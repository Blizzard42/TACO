...
TAG_1="eve_experiments/ensemble"
EXTRA_ARGS_1=""
DELAY_1=0

TASK_2="stack_blocks_two"
TAG_2="eve_experiments/ensemble"
EXTRA_ARGS_2=""
DELAY_2=0

TASK_3="place_container_plate"
TAG_3="eve_experiments/ensemble"
EXTRA_ARGS_3=""
DELAY_3=0

TASK_4="beat_block_hammer"
TAG_4="eve_experiments/ensemble"
EXTRA_ARGS_4=""
DELAY_4=0

TASK_5="handover_block"
TAG_5="eve_experiments/ensemble"
EXTRA_ARGS_5=""
DELAY_5=0

TASK_6="move_can_pot"
TAG_6="eve_experiments/ensemble"
EXTRA_ARGS_6=""
DELAY_6=0

TASK_7="place_object_stand"
TAG_7="eve_experiments/ensemble"
EXTRA_ARGS_7=""
DELAY_7=0
...
RUN_ORDER=(1 2 3 4 5 6 7)
SEEDS=($(seq 3 5))
BASE_EXP_NAME="mar/4/"

# Add or remove your VLM servers here
VLLM_SERVERS=(
    "http://optimistprime:60721"
    "http://clippy:44273"
    "http://shakey:34825"
    "http://cheetah:33683"
    "http://ig-88:44219"
